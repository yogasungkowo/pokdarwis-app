          ...
          <div class="row g-5">
            <div class="col-lg-4">
              ...
              <div class="post-entry lg">
                <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-1.jpg') }}" alt="" class="img-fluid"></a>
              ...
              <div class="row g-5">
                <div class="col-lg-4 border-start custom-border">
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-2.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-5.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-7.jpg') }}" alt="" class="img-fluid"></a>
                ...
                <div class="col-lg-4 border-start custom-border">
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-3.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-6.jpg') }}" alt="" class="img-fluid"></a>
                  ...
                  <div class="post-entry">
                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-8.jpg') }}" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-8">
            <div class="row g-5">
              <div class="col-lg-4 border-start custom-border">
                ...
                <div class="post-list">
                  <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-4.jpg') }}" alt="" class="img-fluid"></a>
