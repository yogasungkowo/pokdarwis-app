                        ...
                        <div class="col-lg-4">
                            <div class="post-entry lg">
                                ...
                                <div class="d-flex align-items-center author">
                                    <div class="photo">
                                        <img src="{{ $post->user->avatar_url ?? asset('assets/img/person-default.jpg') }}" 
                                             alt="{{ $post->user->name }}" 
                                             class="img-fluid">
                                    </div>
                                    <div class="name">
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry">
                                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-2.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Sport</span> <span class="mx-1">•</span> <span>Jul 5th '22</span>
                                    </div>
                                ...
                                <div class="post-entry">
                                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-5.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Food</span> <span class="mx-1">•</span> <span>Jul 17th '22</span>
                                    </div>
                                ...
                                <div class="post-entry">
                                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-7.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Design</span> <span class="mx-1">•</span> <span>Mar 15th '22</span>
                                    </div>
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                ...
                                <div class="post-entry">
                                    <a href="blog-details.html"><img src="{{ asset('assets/img/post-landscape-6.jpg') }}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Tech</span> <span class="mx-1">•</span> <span>Mar 1st '22</span>
                                    </div>
